    ...
    <Container className="my-4">
      <div className="row ">
              ...
              <Form className="bg-info-subtle p-3  rounded-3 ">
                <Form.Group className="mb-3" controlId="emailId">
                  ...
                  <InputGroup className="mb-3">
                    ...
                    />
                  </InputGroup>                  <small className="text-danger">
        ...
        <div className="col-lg-6 col-md-12 col-sm-12">
          ...
          <hr />
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.9059794104787!2d-65.224492889841!3d-26.842942590193424!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94225d65d59f1571%3A0xa30f7b29eb586879!2sTukson%20Pets!5e0!3m2!1ses-419!2sar!4v1695307880963!5m2!1ses-419!2sar"allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="w-100 h-100 rounded-3"></iframe>
        </div>
      </div>
    </Container>
  );
